...
export default function App() {
  ...
  const fetchAdisyoDay = async (dateStr) => {
    ...
    try {
      const res = await fetch(`/api/adisyo?date=${encodeURIComponent(dateStr)}`, { cache: 'no-store' });
      ...
      // Nakit -> cash, yemek kartları toplamı -> meal_cards, kalan kart/online -> credit_card
